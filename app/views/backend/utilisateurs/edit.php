...
<div class="mb-4">
    <h2 class="page-title"><i class="fa-solid fa-user-pen"></i> Modifier l'utilisateur</h2>
    <p class="page-subtitle">Mettez à jour les informations, le rôle ou le mot de passe</p>
</div>
...
<div class="card" style="max-width: 620px;">
    <div class="card-body p-4">
        <form id="formUtilisateurEdit" action="index.php?controller=utilisateur&action=processEdit" method="POST" novalidate>
            <input type="hidden" name="id" value="<?= $utilisateur['id'] ?>">

            <div class="row">
                <div class="col-md-6 mb-3">
                    <label class="form-label">Nom</label>
                    <input type="text" name="nom" id="nomInput" class="form-control" value="<?= htmlspecialchars($utilisateur['nom']) ?>">
                </div>
                <div class="col-md-6 mb-3">
                    <label class="form-label">Prénom</label>
                    <input type="text" name="prenom" id="prenomInput" class="form-control" value="<?= htmlspecialchars($utilisateur['prenom']) ?>">
                </div>
            </div>

            <div class="mb-3">
                <label class="form-label">Email</label>
                <input type="text" name="email" id="emailInput" class="form-control" value="<?= htmlspecialchars($utilisateur['email']) ?>">
            </div>
            ...
            <div class="mb-4">
                ...
                <select name="role" id="roleInput" class="form-select">
                    ...
                    <option value="gestionnaire" <?= $utilisateur['role'] === 'gestionnaire' ? 'selected' : '' ?>>Gestionnaire de réservations</option>
                    <option value="admin_batiments" <?= $utilisateur['role'] === 'admin_batiments' ? 'selected' : '' ?>>Administrateur bâtiments</option>
                </select>
            </div>
...
<script>
document.getElementById('formUtilisateurEdit').addEventListener('submit', function (e) {
